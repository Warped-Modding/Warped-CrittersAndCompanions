...
import com.github.eterdelta.crittersandcompanions.item.DiscItem;
...
public class CACItems {
    ...
    public static final RegistryObject<Item> MUSIC_DISC_WALK = ITEMS.register("music_disc_walk", () -> new DiscItem(7, CACSounds.MUSIC_WALK.get(), (new Item.Properties()).stacksTo(1).tab(CrittersAndCompanions.CREATIVE_TAB), 104));
}